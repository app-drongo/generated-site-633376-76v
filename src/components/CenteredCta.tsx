// Enhanced by AI on 2025-08-13T02:19:10.926Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "99.9%", label: "Client Satisfaction", icon: Shield },
    { value: "10+", label: "Years of Experience", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Unlock your company's full potential with our tailored consulting solutions.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                No obligation, schedule your free consultation today
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Trusted by leading companies with enterprise-grade security
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Customized consulting services to fit your unique business needs
              </p>
            </div>
          </div>
        </div>
