// Enhanced by AI on 2025-08-13T02:19:30.118Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Trusted business consultants helping organizations achieve their goals through strategic
                advisory, digital transformation, and operational excellence.
              </p>
            </div>
